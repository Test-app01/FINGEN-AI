            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Take control of your finances with AI-powered insights, personalized recommendations, and smart
                  automation.
                </p>
              </div>
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={index} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50">
                          <div className="flex items-center gap-3">
                            <div className="p-2 bg-gray-100 rounded-full">{transaction.icon}</div>
                            <div>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-gray-900 to-blue-800 bg-clip-text text-transparent">
            ...
            {[
              {
                ...
                description:
                  "AI-powered insights help you make better investment decisions based on your risk profile and goals.",
                icon: <BarChart2 size={24} className="text-blue-600" />,
              },
              {
                title: "Digital Wallet",
                description:
                  "Secure and convenient way to manage your digital assets with multi-layer security protection.",
                icon: <Wallet size={24} className="text-blue-600" />,
              },
              {
                title: "Instant Transfers",
                description:
                  "Send and receive money instantly, anywhere in the world with minimal fees and maximum security.",
                icon: <Send size={24} className="text-blue-600" />,
              },
              {
                title: "Virtual Cards",
                description:
                  "Create virtual cards for safer online transactions with customizable spending limits and controls.",
                icon: <CreditCard size={24} className="text-blue-600" />,
              },
              {
                title: "Automated Savings",
                description:
                  "Set goals and let AI help you reach them faster with smart saving strategies and recommendations.",
                icon: <PieChart size={24} className="text-blue-600" />,
              },
              {
                title: "Real-time Analytics",
                description:
                  "Track your spending patterns and financial health with beautiful visualizations and actionable insights.",
                icon: <TrendingUp size={24} className="text-blue-600" />,
              },
            ].map((feature, index) => (
              <Card
                key={index}
                className="p-6 hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-white to-gray-50 group"
              >
            ...
            {[
              {
                ...
                description:
                  "Sign up for free and verify your identity in minutes with our secure and streamlined process.",
              },
              {
                step: "02",
                title: "Connect Your Accounts",
                description:
                  "Link your bank accounts and investment portfolios with bank-level security and encryption.",
              },
              {
                step: "03",
                title: "Start Managing",
                description:
                  "Get insights and start making smarter financial decisions with AI-powered recommendations.",
              },
            ].map((item, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "The AI insights have completely transformed how I manage my investments. I've seen a 15% increase in my portfolio performance since I started using FinAI.",
              ...
              {
                quote:
                  "Best financial app I've ever used. The automation features save me hours every month, and the recommendations are spot-on for my financial goals.",
                author: "Michael Chen",
              ...
              {
                quote:
                  "Finally, an app that makes financial management simple and actually enjoyable! The interface is intuitive, and the AI suggestions are incredibly helpful.",
            ...
            {[
              {
                ...
                answer:
                  "We use bank-level 256-bit encryption and follow industry best practices for data security. We never store your bank credentials, and all data is encrypted both in transit and at rest.",
              },
              {
              ...
              },
              {
                ...
                answer:
                  "Our AI analyzes your spending patterns, income, and financial goals to provide personalized recommendations. It learns from your habits and improves over time to give you more accurate insights.",
              },
              {
                question: "Is there a mobile app available?",
                answer:
                  "Yes, we offer mobile apps for both iOS and Android platforms, providing the same powerful features on the go.",
              },
              {
                question: "How do I get support if I have questions?",
                answer:
                  "We offer 24/7 customer support via chat, email, and phone for our paid users. Free users can access our comprehensive knowledge base and community forums.",
              },
            ].map((faq, index) => (
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <span className="text-2xl font-bold text-white bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">
                FinAI
              </span>
